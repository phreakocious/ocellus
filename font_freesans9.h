// FreeSans 9pt GFXfont (Adafruit GFX format, public domain), vendored for treatcat's dialog.
// Adafruit_GFX include stripped -- GFXglyph/GFXfont come from Arduino_GFX_Library.h (include it first).
#pragma once
